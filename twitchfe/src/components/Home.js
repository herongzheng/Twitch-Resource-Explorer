        ...
        <List.Item style={{ marginRight: '20px' }}>
          ...
          >
            ...
            >
              <img
                alt="Placeholder"
                src={item.thumbnail_url.includes('404') ? "https://media-cldnry.s-nbcnews.com/image/upload/t_fit-1240w,f_auto,q_auto:best/rockcms/2022-03/black-lab-favorite-dog-main-220315-e8e0ee.jpg" : processUrl(item.thumbnail_url)}
                style={{ width: "100%", height: "100%" }}
              />
            </a>
          </Card>
